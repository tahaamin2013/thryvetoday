...
const Navbar = () => {
  ...
  return (
    <nav className=" border-b-2 fixed shadow-sm pt-3 pb-1 flex items-center inset-x-0 top-0 z-30 w-full  dark:bg-black/75 bg-white/75 backdrop-blur-lg transition-all">
      <MaxWidthWrapper>
